...
cp ../../checkLogin/index.php omnimaga/OmnomIRC/checkLogin
sed 's/generic/phpbb3/' ../../checkLogin/config.json.php > omnimaga/OmnomIRC/checkLogin/config.json.php
cp ../../checkLogin/hook-phpbb3.php omnimaga/OmnomIRC/checkLogin
